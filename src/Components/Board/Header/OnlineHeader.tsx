      ...
      <div className="online-scores">
        {users &&
          users.map((user, i) => (
            <div
              key={i}
              className="board-header-score__item online-scores__item"
            >
              <p className="board-header-score__item--subtitle">
                {" "}
                {user.username === username ? "You" : user.username}{" "}
              </p>
              <div className="online-scores-nbr">
                <p className="board-header-score__item--nbr">
                  {scores && scores[user.username]}
                </p>
              </div>
            </div>
          ))}
