import { LOADING, NEW_BOT_SHOT_TYPE, NEW_SCORE, NEW_SHOT, REPLAY_GAME, STOP_LOADING, NEW_WINNER } from "./actions";
...
export type OfflineAction = NewShotAction | NewWinnerAction | NewScore | NewBotShotTypeAction | LoadingAction | StopLoadingAction | ReplayGameAction;
